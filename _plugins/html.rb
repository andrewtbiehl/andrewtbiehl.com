...
module Kramdown
  module Converter
    ...
    class Html
      ...
      #
      # Returns a syntax-highlighted version of the code based on its associated
      # language, wrapped in a <code> element inside a <pre> element. A data attribute
      # is also added to the <code> element containing the language of the code block.
      #
      ...
      # attribute), then the code is also syntax highlighted and a data attribute is
      # added to the <code> element containing the associated language.
      #
      # This customized version was built for use with the bare-bones
      # Rouge::Formatters::HTML syntax highlighter and may produce unexpected results
      # if used incautiously with other highlighters.
      ...
      # Utility method for extracting the content, attributes, and language of a block
      # (or span) of code, for use in formatting the code as HTML.
